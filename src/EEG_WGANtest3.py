...
parser.add_argument("--lr1", type=float, default=0.0001, help="adam: learning rate generator")
parser.add_argument("--lr2", type=float, default=0.00005, help="adam: learning rate discriminator")
...
parser.add_argument('--nz', type=int, default=50, help="size of the latent z vector used as the generator input.")
...
class Generator(nn.Module):
    ...
    def forward(self, z):
        out = self.layer1(z)
        out = out.view(out.size(0), 4, 1, 25)
        out = self.layer2(out)
        out = self.layer3(out)
        out = self.layer4(out)
...
summary(generator, (1, 50))
summary(discriminator, (1, 8, 240))
