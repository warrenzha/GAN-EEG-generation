...
filename1 = "GAN_fakeA_05-03-15-21.npy"
...
data_fake = preprocess(data_fake, mean_inception, std_inception)
data_real = preprocess(data_real, mean_inception, std_inception)
data_noise = preprocess(data_noise, mean_inception, std_inception)
